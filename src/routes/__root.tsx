...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Monte seu Look - Saint Leez é um site criado pela San Diego para visualizar e escolher camisetas e estampas DTF de um jeito inovador." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Saint Leez - Estampas DTF" },
      { property: "og:description", content: "Monte seu Look - Saint Leez é um site criado pela San Diego para visualizar e escolher camisetas e estampas DTF de um jeito inovador." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Saint Leez - Estampas DTF" },
      { name: "twitter:description", content: "Monte seu Look - Saint Leez é um site criado pela San Diego para visualizar e escolher camisetas e estampas DTF de um jeito inovador." },
